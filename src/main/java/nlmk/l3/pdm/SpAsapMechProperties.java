...
public class SpAsapMechProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 7643636339029256374L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpAsapMechProperties\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpAsapMechProperties> ENCODER =
      new BinaryMessageEncoder<SpAsapMechProperties>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpAsapMechProperties> DECODER =
      new BinaryMessageDecoder<SpAsapMechProperties>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpAsapMechProperties> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpAsapMechProperties> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpAsapMechProperties> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpAsapMechProperties>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpAsapMechProperties to a ByteBuffer.
  ...
  /**
   * Deserializes a SpAsapMechProperties from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpAsapMechProperties instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpAsapMechProperties fromByteBuffer(
   ...
   */
  public SpAsapMechProperties(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpAsapMechProperties RecordBuilder.
   * @return A new SpAsapMechProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapMechProperties.Builder newBuilder() {
    return new nlmk.l3.pdm.SpAsapMechProperties.Builder();
  }

  /**
   * Creates a new SpAsapMechProperties RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpAsapMechProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapMechProperties.Builder newBuilder(nlmk.l3.pdm.SpAsapMechProperties.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpAsapMechProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpAsapMechProperties.Builder(other);
    }
  }

  /**
   * Creates a new SpAsapMechProperties RecordBuilder by copying an existing SpAsapMechProperties instance.
   * @param other The existing instance to copy.
   * @return A new SpAsapMechProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapMechProperties.Builder newBuilder(nlmk.l3.pdm.SpAsapMechProperties other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpAsapMechProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpAsapMechProperties.Builder(other);
  ...
  /**
   * RecordBuilder for SpAsapMechProperties instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpAsapMechProperties>
    implements org.apache.avro.data.RecordBuilder<SpAsapMechProperties> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpAsapMechProperties.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpAsapMechProperties instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpAsapMechProperties other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpAsapMechProperties.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpAsapMechProperties.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapMechProperties.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpAsapMechProperties build() {
      try {
        SpAsapMechProperties record = new SpAsapMechProperties();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpAsapMechProperties>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpAsapMechProperties>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpAsapMechProperties>
    READER$ = (org.apache.avro.io.DatumReader<SpAsapMechProperties>)MODEL$.createDatumReader(SCHEMA$);
