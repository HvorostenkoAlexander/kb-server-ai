...
public class SpTolLength extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SpTolLength(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
   ...
   */
  public static nlmk.l3.pdm.SpTolLength.Builder newBuilder() {
    return new nlmk.l3.pdm.SpTolLength.Builder();
  }
   ...
   * @return A new SpTolLength RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolLength.Builder newBuilder(nlmk.l3.pdm.SpTolLength.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolLength.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolLength.Builder(other);
    }
  }
   ...
   * @return A new SpTolLength RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolLength.Builder newBuilder(nlmk.l3.pdm.SpTolLength other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolLength.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolLength.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpTolLength>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolLength.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolLength other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpTolLength.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpTolLength.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolLength.Builder clearData() {
      data = null;
      dataBuilder = null;
