...
public class SpMatchRabplanNum extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -5774060670100532271L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpMatchRabplanNum\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpMatchRabplanNum> ENCODER =
      new BinaryMessageEncoder<SpMatchRabplanNum>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpMatchRabplanNum> DECODER =
      new BinaryMessageDecoder<SpMatchRabplanNum>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpMatchRabplanNum> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpMatchRabplanNum> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpMatchRabplanNum> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpMatchRabplanNum>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpMatchRabplanNum to a ByteBuffer.
  ...
  /**
   * Deserializes a SpMatchRabplanNum from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpMatchRabplanNum instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpMatchRabplanNum fromByteBuffer(
   ...
   */
  public SpMatchRabplanNum(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpMatchRabplanNum RecordBuilder.
   * @return A new SpMatchRabplanNum RecordBuilder
   */
  public static nlmk.l3.pdm.SpMatchRabplanNum.Builder newBuilder() {
    return new nlmk.l3.pdm.SpMatchRabplanNum.Builder();
  }

  /**
   * Creates a new SpMatchRabplanNum RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpMatchRabplanNum RecordBuilder
   */
  public static nlmk.l3.pdm.SpMatchRabplanNum.Builder newBuilder(nlmk.l3.pdm.SpMatchRabplanNum.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpMatchRabplanNum.Builder();
    } else {
      return new nlmk.l3.pdm.SpMatchRabplanNum.Builder(other);
    }
  }

  /**
   * Creates a new SpMatchRabplanNum RecordBuilder by copying an existing SpMatchRabplanNum instance.
   * @param other The existing instance to copy.
   * @return A new SpMatchRabplanNum RecordBuilder
   */
  public static nlmk.l3.pdm.SpMatchRabplanNum.Builder newBuilder(nlmk.l3.pdm.SpMatchRabplanNum other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpMatchRabplanNum.Builder();
    } else {
      return new nlmk.l3.pdm.SpMatchRabplanNum.Builder(other);
  ...
  /**
   * RecordBuilder for SpMatchRabplanNum instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpMatchRabplanNum>
    implements org.apache.avro.data.RecordBuilder<SpMatchRabplanNum> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpMatchRabplanNum.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpMatchRabplanNum instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpMatchRabplanNum other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchRabplanNum.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpMatchRabplanNum build() {
      try {
        SpMatchRabplanNum record = new SpMatchRabplanNum();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpMatchRabplanNum>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpMatchRabplanNum>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpMatchRabplanNum>
    READER$ = (org.apache.avro.io.DatumReader<SpMatchRabplanNum>)MODEL$.createDatumReader(SCHEMA$);
