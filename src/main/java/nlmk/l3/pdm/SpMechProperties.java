...
public class SpMechProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1738501127042162281L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpMechProperties\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpMechProperties> ENCODER =
      new BinaryMessageEncoder<SpMechProperties>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpMechProperties> DECODER =
      new BinaryMessageDecoder<SpMechProperties>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpMechProperties> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpMechProperties> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpMechProperties> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpMechProperties>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpMechProperties to a ByteBuffer.
  ...
  /**
   * Deserializes a SpMechProperties from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpMechProperties instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpMechProperties fromByteBuffer(
   ...
   */
  public SpMechProperties(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpMechProperties RecordBuilder.
   * @return A new SpMechProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpMechProperties.Builder newBuilder() {
    return new nlmk.l3.pdm.SpMechProperties.Builder();
  }

  /**
   * Creates a new SpMechProperties RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpMechProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpMechProperties.Builder newBuilder(nlmk.l3.pdm.SpMechProperties.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpMechProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpMechProperties.Builder(other);
    }
  }

  /**
   * Creates a new SpMechProperties RecordBuilder by copying an existing SpMechProperties instance.
   * @param other The existing instance to copy.
   * @return A new SpMechProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpMechProperties.Builder newBuilder(nlmk.l3.pdm.SpMechProperties other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpMechProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpMechProperties.Builder(other);
  ...
  /**
   * RecordBuilder for SpMechProperties instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpMechProperties>
    implements org.apache.avro.data.RecordBuilder<SpMechProperties> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpMechProperties.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpMechProperties instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpMechProperties other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpMechProperties.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpMechProperties.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMechProperties.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpMechProperties build() {
      try {
        SpMechProperties record = new SpMechProperties();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpMechProperties>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpMechProperties>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpMechProperties>
    READER$ = (org.apache.avro.io.DatumReader<SpMechProperties>)MODEL$.createDatumReader(SCHEMA$);
