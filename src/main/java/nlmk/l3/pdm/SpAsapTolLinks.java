...
public class SpAsapTolLinks extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8778007844178338727L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpAsapTolLinks\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpAsapTolLinks> ENCODER =
      new BinaryMessageEncoder<SpAsapTolLinks>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpAsapTolLinks> DECODER =
      new BinaryMessageDecoder<SpAsapTolLinks>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpAsapTolLinks> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpAsapTolLinks> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpAsapTolLinks> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpAsapTolLinks>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpAsapTolLinks to a ByteBuffer.
  ...
  /**
   * Deserializes a SpAsapTolLinks from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpAsapTolLinks instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpAsapTolLinks fromByteBuffer(
   ...
   */
  public SpAsapTolLinks(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpAsapTolLinks RecordBuilder.
   * @return A new SpAsapTolLinks RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapTolLinks.Builder newBuilder() {
    return new nlmk.l3.pdm.SpAsapTolLinks.Builder();
  }

  /**
   * Creates a new SpAsapTolLinks RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpAsapTolLinks RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapTolLinks.Builder newBuilder(nlmk.l3.pdm.SpAsapTolLinks.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpAsapTolLinks.Builder();
    } else {
      return new nlmk.l3.pdm.SpAsapTolLinks.Builder(other);
    }
  }

  /**
   * Creates a new SpAsapTolLinks RecordBuilder by copying an existing SpAsapTolLinks instance.
   * @param other The existing instance to copy.
   * @return A new SpAsapTolLinks RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapTolLinks.Builder newBuilder(nlmk.l3.pdm.SpAsapTolLinks other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpAsapTolLinks.Builder();
    } else {
      return new nlmk.l3.pdm.SpAsapTolLinks.Builder(other);
  ...
  /**
   * RecordBuilder for SpAsapTolLinks instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpAsapTolLinks>
    implements org.apache.avro.data.RecordBuilder<SpAsapTolLinks> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpAsapTolLinks.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpAsapTolLinks instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpAsapTolLinks other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpAsapTolLinks.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpAsapTolLinks.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapTolLinks.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpAsapTolLinks build() {
      try {
        SpAsapTolLinks record = new SpAsapTolLinks();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpAsapTolLinks>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpAsapTolLinks>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpAsapTolLinks>
    READER$ = (org.apache.avro.io.DatumReader<SpAsapTolLinks>)MODEL$.createDatumReader(SCHEMA$);
