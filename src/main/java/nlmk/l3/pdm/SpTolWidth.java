...
public class SpTolWidth extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2022581558526404634L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpTolWidth\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpTolWidth> ENCODER =
      new BinaryMessageEncoder<SpTolWidth>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpTolWidth> DECODER =
      new BinaryMessageDecoder<SpTolWidth>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpTolWidth> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpTolWidth> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpTolWidth> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpTolWidth>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpTolWidth to a ByteBuffer.
  ...
  /**
   * Deserializes a SpTolWidth from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpTolWidth instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpTolWidth fromByteBuffer(
   ...
   */
  public SpTolWidth(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpTolWidth RecordBuilder.
   * @return A new SpTolWidth RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolWidth.Builder newBuilder() {
    return new nlmk.l3.pdm.SpTolWidth.Builder();
  }

  /**
   * Creates a new SpTolWidth RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpTolWidth RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolWidth.Builder newBuilder(nlmk.l3.pdm.SpTolWidth.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolWidth.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolWidth.Builder(other);
    }
  }

  /**
   * Creates a new SpTolWidth RecordBuilder by copying an existing SpTolWidth instance.
   * @param other The existing instance to copy.
   * @return A new SpTolWidth RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolWidth.Builder newBuilder(nlmk.l3.pdm.SpTolWidth other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolWidth.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolWidth.Builder(other);
  ...
  /**
   * RecordBuilder for SpTolWidth instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpTolWidth>
    implements org.apache.avro.data.RecordBuilder<SpTolWidth> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolWidth.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpTolWidth instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolWidth other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpTolWidth.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpTolWidth.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolWidth.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpTolWidth build() {
      try {
        SpTolWidth record = new SpTolWidth();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpTolWidth>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpTolWidth>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpTolWidth>
    READER$ = (org.apache.avro.io.DatumReader<SpTolWidth>)MODEL$.createDatumReader(SCHEMA$);
