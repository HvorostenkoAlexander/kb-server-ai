...
public class SpChemicalProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 1625431205733907611L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpChemicalProperties\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpChemicalProperties> ENCODER =
      new BinaryMessageEncoder<SpChemicalProperties>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpChemicalProperties> DECODER =
      new BinaryMessageDecoder<SpChemicalProperties>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpChemicalProperties> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpChemicalProperties> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpChemicalProperties> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpChemicalProperties>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpChemicalProperties to a ByteBuffer.
  ...
  /**
   * Deserializes a SpChemicalProperties from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpChemicalProperties instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpChemicalProperties fromByteBuffer(
   ...
   */
  public SpChemicalProperties(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpChemicalProperties RecordBuilder.
   * @return A new SpChemicalProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpChemicalProperties.Builder newBuilder() {
    return new nlmk.l3.pdm.SpChemicalProperties.Builder();
  }

  /**
   * Creates a new SpChemicalProperties RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpChemicalProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpChemicalProperties.Builder newBuilder(nlmk.l3.pdm.SpChemicalProperties.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpChemicalProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpChemicalProperties.Builder(other);
    }
  }

  /**
   * Creates a new SpChemicalProperties RecordBuilder by copying an existing SpChemicalProperties instance.
   * @param other The existing instance to copy.
   * @return A new SpChemicalProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpChemicalProperties.Builder newBuilder(nlmk.l3.pdm.SpChemicalProperties other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpChemicalProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpChemicalProperties.Builder(other);
  ...
  /**
   * RecordBuilder for SpChemicalProperties instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpChemicalProperties>
    implements org.apache.avro.data.RecordBuilder<SpChemicalProperties> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpChemicalProperties.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpChemicalProperties instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpChemicalProperties other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpChemicalProperties.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpChemicalProperties.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpChemicalProperties.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpChemicalProperties build() {
      try {
        SpChemicalProperties record = new SpChemicalProperties();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpChemicalProperties>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpChemicalProperties>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpChemicalProperties>
    READER$ = (org.apache.avro.io.DatumReader<SpChemicalProperties>)MODEL$.createDatumReader(SCHEMA$);
