...
public class SpPcm extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 174033969927707614L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpPcm\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpPcm> ENCODER =
      new BinaryMessageEncoder<SpPcm>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpPcm> DECODER =
      new BinaryMessageDecoder<SpPcm>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpPcm> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpPcm> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpPcm> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpPcm>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpPcm to a ByteBuffer.
  ...
  /**
   * Deserializes a SpPcm from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpPcm instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpPcm fromByteBuffer(
   ...
   */
  public SpPcm(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpPcm RecordBuilder.
   * @return A new SpPcm RecordBuilder
   */
  public static nlmk.l3.pdm.SpPcm.Builder newBuilder() {
    return new nlmk.l3.pdm.SpPcm.Builder();
  }

  /**
   * Creates a new SpPcm RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpPcm RecordBuilder
   */
  public static nlmk.l3.pdm.SpPcm.Builder newBuilder(nlmk.l3.pdm.SpPcm.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpPcm.Builder();
    } else {
      return new nlmk.l3.pdm.SpPcm.Builder(other);
    }
  }

  /**
   * Creates a new SpPcm RecordBuilder by copying an existing SpPcm instance.
   * @param other The existing instance to copy.
   * @return A new SpPcm RecordBuilder
   */
  public static nlmk.l3.pdm.SpPcm.Builder newBuilder(nlmk.l3.pdm.SpPcm other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpPcm.Builder();
    } else {
      return new nlmk.l3.pdm.SpPcm.Builder(other);
  ...
  /**
   * RecordBuilder for SpPcm instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpPcm>
    implements org.apache.avro.data.RecordBuilder<SpPcm> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpPcm.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpPcm instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpPcm other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpPcm.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpPcm.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpPcm.Builder clearData() {
      data = null;
      dataBuilder = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpPcm>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpPcm>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpPcm>
    READER$ = (org.apache.avro.io.DatumReader<SpPcm>)MODEL$.createDatumReader(SCHEMA$);
