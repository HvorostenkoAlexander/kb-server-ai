...
public class SpKatSteelMarkGost4041 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -6921935687403723407L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpKatSteelMarkGost4041\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpKatSteelMarkGost4041> ENCODER =
      new BinaryMessageEncoder<SpKatSteelMarkGost4041>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpKatSteelMarkGost4041> DECODER =
      new BinaryMessageDecoder<SpKatSteelMarkGost4041>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpKatSteelMarkGost4041> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpKatSteelMarkGost4041> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpKatSteelMarkGost4041> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpKatSteelMarkGost4041>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpKatSteelMarkGost4041 to a ByteBuffer.
  ...
  /**
   * Deserializes a SpKatSteelMarkGost4041 from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpKatSteelMarkGost4041 instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpKatSteelMarkGost4041 fromByteBuffer(
   ...
   */
  public SpKatSteelMarkGost4041(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpKatSteelMarkGost4041 RecordBuilder.
   * @return A new SpKatSteelMarkGost4041 RecordBuilder
   */
  public static nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder newBuilder() {
    return new nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder();
  }

  /**
   * Creates a new SpKatSteelMarkGost4041 RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpKatSteelMarkGost4041 RecordBuilder
   */
  public static nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder newBuilder(nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder();
    } else {
      return new nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder(other);
    }
  }

  /**
   * Creates a new SpKatSteelMarkGost4041 RecordBuilder by copying an existing SpKatSteelMarkGost4041 instance.
   * @param other The existing instance to copy.
   * @return A new SpKatSteelMarkGost4041 RecordBuilder
   */
  public static nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder newBuilder(nlmk.l3.pdm.SpKatSteelMarkGost4041 other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder();
    } else {
      return new nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder(other);
  ...
  /**
   * RecordBuilder for SpKatSteelMarkGost4041 instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpKatSteelMarkGost4041>
    implements org.apache.avro.data.RecordBuilder<SpKatSteelMarkGost4041> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpKatSteelMarkGost4041 instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpKatSteelMarkGost4041 other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpKatSteelMarkGost4041.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpKatSteelMarkGost4041 build() {
      try {
        SpKatSteelMarkGost4041 record = new SpKatSteelMarkGost4041();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpKatSteelMarkGost4041>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpKatSteelMarkGost4041>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpKatSteelMarkGost4041>
    READER$ = (org.apache.avro.io.DatumReader<SpKatSteelMarkGost4041>)MODEL$.createDatumReader(SCHEMA$);
