...
public class SpMatchTkNum extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6481834504279136485L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpMatchTkNum\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpMatchTkNum> ENCODER =
      new BinaryMessageEncoder<SpMatchTkNum>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpMatchTkNum> DECODER =
      new BinaryMessageDecoder<SpMatchTkNum>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpMatchTkNum> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpMatchTkNum> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpMatchTkNum> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpMatchTkNum>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpMatchTkNum to a ByteBuffer.
  ...
  /**
   * Deserializes a SpMatchTkNum from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpMatchTkNum instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpMatchTkNum fromByteBuffer(
   ...
   */
  public SpMatchTkNum(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpMatchTkNum RecordBuilder.
   * @return A new SpMatchTkNum RecordBuilder
   */
  public static nlmk.l3.pdm.SpMatchTkNum.Builder newBuilder() {
    return new nlmk.l3.pdm.SpMatchTkNum.Builder();
  }

  /**
   * Creates a new SpMatchTkNum RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpMatchTkNum RecordBuilder
   */
  public static nlmk.l3.pdm.SpMatchTkNum.Builder newBuilder(nlmk.l3.pdm.SpMatchTkNum.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpMatchTkNum.Builder();
    } else {
      return new nlmk.l3.pdm.SpMatchTkNum.Builder(other);
    }
  }

  /**
   * Creates a new SpMatchTkNum RecordBuilder by copying an existing SpMatchTkNum instance.
   * @param other The existing instance to copy.
   * @return A new SpMatchTkNum RecordBuilder
   */
  public static nlmk.l3.pdm.SpMatchTkNum.Builder newBuilder(nlmk.l3.pdm.SpMatchTkNum other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpMatchTkNum.Builder();
    } else {
      return new nlmk.l3.pdm.SpMatchTkNum.Builder(other);
  ...
  /**
   * RecordBuilder for SpMatchTkNum instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpMatchTkNum>
    implements org.apache.avro.data.RecordBuilder<SpMatchTkNum> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpMatchTkNum.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpMatchTkNum instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpMatchTkNum other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpMatchTkNum.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpMatchTkNum.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpMatchTkNum.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpMatchTkNum build() {
      try {
        SpMatchTkNum record = new SpMatchTkNum();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpMatchTkNum>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpMatchTkNum>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpMatchTkNum>
    READER$ = (org.apache.avro.io.DatumReader<SpMatchTkNum>)MODEL$.createDatumReader(SCHEMA$);
