...
public class SpAsapChemicalProperties extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public SpAsapChemicalProperties(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
   ...
   */
  public static nlmk.l3.pdm.SpAsapChemicalProperties.Builder newBuilder() {
    return new nlmk.l3.pdm.SpAsapChemicalProperties.Builder();
  }
   ...
   * @return A new SpAsapChemicalProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapChemicalProperties.Builder newBuilder(nlmk.l3.pdm.SpAsapChemicalProperties.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpAsapChemicalProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpAsapChemicalProperties.Builder(other);
    }
  }
   ...
   * @return A new SpAsapChemicalProperties RecordBuilder
   */
  public static nlmk.l3.pdm.SpAsapChemicalProperties.Builder newBuilder(nlmk.l3.pdm.SpAsapChemicalProperties other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpAsapChemicalProperties.Builder();
    } else {
      return new nlmk.l3.pdm.SpAsapChemicalProperties.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpAsapChemicalProperties>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpAsapChemicalProperties.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpAsapChemicalProperties other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpAsapChemicalProperties.Builder clearData() {
      data = null;
      dataBuilder = null;
