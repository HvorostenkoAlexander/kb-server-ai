...
public class SpTolThick extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -662289106767541754L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpTolThick\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpTolThick> ENCODER =
      new BinaryMessageEncoder<SpTolThick>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpTolThick> DECODER =
      new BinaryMessageDecoder<SpTolThick>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpTolThick> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpTolThick> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpTolThick> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpTolThick>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpTolThick to a ByteBuffer.
  ...
  /**
   * Deserializes a SpTolThick from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpTolThick instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpTolThick fromByteBuffer(
   ...
   */
  public SpTolThick(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpTolThick RecordBuilder.
   * @return A new SpTolThick RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolThick.Builder newBuilder() {
    return new nlmk.l3.pdm.SpTolThick.Builder();
  }

  /**
   * Creates a new SpTolThick RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpTolThick RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolThick.Builder newBuilder(nlmk.l3.pdm.SpTolThick.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolThick.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolThick.Builder(other);
    }
  }

  /**
   * Creates a new SpTolThick RecordBuilder by copying an existing SpTolThick instance.
   * @param other The existing instance to copy.
   * @return A new SpTolThick RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolThick.Builder newBuilder(nlmk.l3.pdm.SpTolThick other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolThick.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolThick.Builder(other);
  ...
  /**
   * RecordBuilder for SpTolThick instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpTolThick>
    implements org.apache.avro.data.RecordBuilder<SpTolThick> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolThick.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpTolThick instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolThick other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpTolThick.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpTolThick.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolThick.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpTolThick build() {
      try {
        SpTolThick record = new SpTolThick();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpTolThick>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpTolThick>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpTolThick>
    READER$ = (org.apache.avro.io.DatumReader<SpTolThick>)MODEL$.createDatumReader(SCHEMA$);
