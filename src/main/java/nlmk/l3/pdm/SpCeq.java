...
public class SpCeq extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3574780450429300077L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpCeq\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpCeq> ENCODER =
      new BinaryMessageEncoder<SpCeq>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpCeq> DECODER =
      new BinaryMessageDecoder<SpCeq>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpCeq> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpCeq> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpCeq> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpCeq>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpCeq to a ByteBuffer.
  ...
  /**
   * Deserializes a SpCeq from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpCeq instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpCeq fromByteBuffer(
   ...
   */
  public SpCeq(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpCeq RecordBuilder.
   * @return A new SpCeq RecordBuilder
   */
  public static nlmk.l3.pdm.SpCeq.Builder newBuilder() {
    return new nlmk.l3.pdm.SpCeq.Builder();
  }

  /**
   * Creates a new SpCeq RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpCeq RecordBuilder
   */
  public static nlmk.l3.pdm.SpCeq.Builder newBuilder(nlmk.l3.pdm.SpCeq.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpCeq.Builder();
    } else {
      return new nlmk.l3.pdm.SpCeq.Builder(other);
    }
  }

  /**
   * Creates a new SpCeq RecordBuilder by copying an existing SpCeq instance.
   * @param other The existing instance to copy.
   * @return A new SpCeq RecordBuilder
   */
  public static nlmk.l3.pdm.SpCeq.Builder newBuilder(nlmk.l3.pdm.SpCeq other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpCeq.Builder();
    } else {
      return new nlmk.l3.pdm.SpCeq.Builder(other);
  ...
  /**
   * RecordBuilder for SpCeq instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpCeq>
    implements org.apache.avro.data.RecordBuilder<SpCeq> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpCeq.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpCeq instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpCeq other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpCeq.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpCeq.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpCeq.Builder clearData() {
      data = null;
      dataBuilder = null;
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpCeq>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpCeq>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpCeq>
    READER$ = (org.apache.avro.io.DatumReader<SpCeq>)MODEL$.createDatumReader(SCHEMA$);
