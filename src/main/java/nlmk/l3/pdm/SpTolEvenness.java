...
public class SpTolEvenness extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5618524535164365296L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"SpTolEvenness\",\"namespace\":\"nlmk.l3.pdm\",\"fields\":[{\"name\":\"ts\",\"type\":\"string\"},{\"name\":\"op\",\"type\":{\"type\":\"enum\",\"name\":\"opEnum\",\"symbols\":[\"I\",\"U\",\"D\"]}},{\"name\":\"pk\",\"type\":{\"type\":\"record\",\"name\":\"Pk\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\"},{\"name\":\"directoryId\",\"type\":\"string\"},{\"name\":\"Id\",\"type\":\"string\"}]}},{\"name\":\"data\",\"type\":{\"type\":\"record\",\"name\":\"Data\",\"fields\":[{\"name\":\"specifications\",\"type\":{\"type\":\"array\",\"items\":{\"type\":\"record\",\"name\":\"Spec\",\"fields\":[{\"name\":\"specCode\",\"type\":\"int\"},{\"name\":\"specName\",\"type\":\"string\"},{\"name\":\"specTypeCode\",\"type\":\"int\"},{\"name\":\"specValue\",\"type\":\"string\"},{\"name\":\"specMeasure\",\"type\":\"string\"}]}}}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }

  private static SpecificData MODEL$ = new SpecificData();

  private static final BinaryMessageEncoder<SpTolEvenness> ENCODER =
      new BinaryMessageEncoder<SpTolEvenness>(MODEL$, SCHEMA$);

  private static final BinaryMessageDecoder<SpTolEvenness> DECODER =
      new BinaryMessageDecoder<SpTolEvenness>(MODEL$, SCHEMA$);

  /**
   * Return the BinaryMessageEncoder instance used by this class.
   * @return the message encoder used by this class
   */
  public static BinaryMessageEncoder<SpTolEvenness> getEncoder() {
    return ENCODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpTolEvenness> getDecoder() {
    return DECODER;
  }
   ...
   */
  public static BinaryMessageDecoder<SpTolEvenness> createDecoder(SchemaStore resolver) {
    return new BinaryMessageDecoder<SpTolEvenness>(MODEL$, SCHEMA$, resolver);
  }

  /**
   * Serializes this SpTolEvenness to a ByteBuffer.
  ...
  /**
   * Deserializes a SpTolEvenness from a ByteBuffer.
   * @param b a byte buffer holding serialized data for an instance of this class
   * @return a SpTolEvenness instance decoded from the given buffer
   * @throws java.io.IOException if the given bytes could not be deserialized into an instance of this class
   */
  public static SpTolEvenness fromByteBuffer(
   ...
   */
  public SpTolEvenness(java.lang.CharSequence ts, nlmk.l3.pdm.opEnum op, nlmk.l3.pdm.Pk pk, nlmk.l3.pdm.Data data) {
    this.ts = ts;
    this.op = op;
    this.pk = pk;
    this.data = data;
  ...
  /**
   * Creates a new SpTolEvenness RecordBuilder.
   * @return A new SpTolEvenness RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolEvenness.Builder newBuilder() {
    return new nlmk.l3.pdm.SpTolEvenness.Builder();
  }

  /**
   * Creates a new SpTolEvenness RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new SpTolEvenness RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolEvenness.Builder newBuilder(nlmk.l3.pdm.SpTolEvenness.Builder other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolEvenness.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolEvenness.Builder(other);
    }
  }

  /**
   * Creates a new SpTolEvenness RecordBuilder by copying an existing SpTolEvenness instance.
   * @param other The existing instance to copy.
   * @return A new SpTolEvenness RecordBuilder
   */
  public static nlmk.l3.pdm.SpTolEvenness.Builder newBuilder(nlmk.l3.pdm.SpTolEvenness other) {
    if (other == null) {
      return new nlmk.l3.pdm.SpTolEvenness.Builder();
    } else {
      return new nlmk.l3.pdm.SpTolEvenness.Builder(other);
  ...
  /**
   * RecordBuilder for SpTolEvenness instances.
   */
  @org.apache.avro.specific.AvroGenerated
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SpTolEvenness>
    implements org.apache.avro.data.RecordBuilder<SpTolEvenness> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolEvenness.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing SpTolEvenness instance
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.pdm.SpTolEvenness other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.ts)) {
        this.ts = data().deepCopy(fields()[0].schema(), other.ts);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder setTs(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder clearTs() {
      ts = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder setOp(nlmk.l3.pdm.opEnum value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder setPk(nlmk.l3.pdm.Pk value) {
    ...
    public nlmk.l3.pdm.SpTolEvenness.Builder setPkBuilder(nlmk.l3.pdm.Pk.Builder value) {
      clearPk();
      pkBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder clearPk() {
      pk = null;
      pkBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder setData(nlmk.l3.pdm.Data value) {
    ...
    public nlmk.l3.pdm.SpTolEvenness.Builder setDataBuilder(nlmk.l3.pdm.Data.Builder value) {
      clearData();
      dataBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.pdm.SpTolEvenness.Builder clearData() {
      data = null;
      dataBuilder = null;
    ...
    public SpTolEvenness build() {
      try {
        SpTolEvenness record = new SpTolEvenness();
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumWriter<SpTolEvenness>
    WRITER$ = (org.apache.avro.io.DatumWriter<SpTolEvenness>)MODEL$.createDatumWriter(SCHEMA$);
  ...
  @SuppressWarnings("unchecked")
  private static final org.apache.avro.io.DatumReader<SpTolEvenness>
    READER$ = (org.apache.avro.io.DatumReader<SpTolEvenness>)MODEL$.createDatumReader(SCHEMA$);
