...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5922380578876209484L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordPk\",\"namespace\":\"nlmk.l3.apcs\",\"fields\":[{\"name\":\"systemCode\",\"type\":\"string\",\"doc\":\"Код системы\"},{\"name\":\"id\",\"type\":\"int\",\"doc\":\"ИД результата аттестации\"}]}");
   ...
   * @param id ИД результата аттестации
   */
  public RecordPk(java.lang.CharSequence systemCode, java.lang.Integer id) {
   ...
   * @return ИД результата аттестации
   */
  public int getId() {
    return id;
  }
   ...
   */
  public static nlmk.l3.apcs.RecordPk.Builder newBuilder() {
    return new nlmk.l3.apcs.RecordPk.Builder();
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.apcs.RecordPk.Builder newBuilder(nlmk.l3.apcs.RecordPk.Builder other) {
    if (other == null) {
      return new nlmk.l3.apcs.RecordPk.Builder();
    } else {
      return new nlmk.l3.apcs.RecordPk.Builder(other);
    }
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.l3.apcs.RecordPk.Builder newBuilder(nlmk.l3.apcs.RecordPk other) {
    if (other == null) {
      return new nlmk.l3.apcs.RecordPk.Builder();
    } else {
      return new nlmk.l3.apcs.RecordPk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.l3.apcs.RecordPk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.l3.apcs.RecordPk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.systemCode)) {
        this.systemCode = data().deepCopy(fields()[0].schema(), other.systemCode);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.apcs.RecordPk.Builder setSystemCode(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.apcs.RecordPk.Builder clearSystemCode() {
      systemCode = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.apcs.RecordPk.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.l3.apcs.RecordPk.Builder clearId() {
