...
public class RecordPk extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1046535942839609693L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"RecordPk\",\"namespace\":\"nlmk.apcs.verification.results.cgp.v0\",\"fields\":[{\"name\":\"id\",\"type\":\"long\",\"doc\":\"ИД результата аттестации\"}]}");
   ...
   */
  public RecordPk(java.lang.Long id) {
    this.id = id;
  }
   ...
   */
  public static nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder newBuilder() {
    return new nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder();
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder newBuilder(nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder other) {
    if (other == null) {
      return new nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder();
    } else {
      return new nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder(other);
    }
  }
   ...
   * @return A new RecordPk RecordBuilder
   */
  public static nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder newBuilder(nlmk.apcs.verification.results.cgp.v0.RecordPk other) {
    if (other == null) {
      return new nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder();
    } else {
      return new nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RecordPk>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(nlmk.apcs.verification.results.cgp.v0.RecordPk other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder setId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public nlmk.apcs.verification.results.cgp.v0.RecordPk.Builder clearId() {
