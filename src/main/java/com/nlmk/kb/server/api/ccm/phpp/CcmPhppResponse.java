...
/**
 * Ответ на Аттестацию Единицы Продукции, цех ЦХПП<br>
...
public class CcmPhppResponse {
    ...
    public static class AttestationValue {
        ...
        @NotNull
        private Integer docId; // Нормирующий документ
        @NotBlank
        private String docName; // Название нормирующего документа
