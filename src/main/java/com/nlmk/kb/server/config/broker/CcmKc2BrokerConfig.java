...
public class CcmKc2BrokerConfig {

    private final CcmKc2ConsumerProperties consumerProperties;
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AttestationRequest> ccmKc2KafkaListenerContainerFactory() {
