...
public class CcmKc1BrokerConfig {

    private final CcmKc1ConsumerProperties consumerProperties;
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, AttestationRequest> ccmKc1KafkaListenerContainerFactory() {
