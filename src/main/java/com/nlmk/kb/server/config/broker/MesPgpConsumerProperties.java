...
@Getter
@Component
public class MesPgpConsumerProperties extends ConsumerProperties {
    public MesPgpConsumerProperties(@Value("${kafka.mes.pgp.bootstrap-servers}") String kafkaServer,
