...
@Service
public class TolShapeSlabSender extends BasePdmCreator implements PdmMessageSender, PdmMessageCreator {
    ...
    public Long send(PdmMessage message) {
        ...
        return super.getNsiSender().sendBodyReturnLong(
                super.getPdmDtoConverter().toTolShapeSlabDto(message.getDictionary()),
