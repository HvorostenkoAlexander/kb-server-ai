...
@Slf4j
@Service
public class MatchTkNumMessageSender extends BaseCreator implements MessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        final var sendingDto = super.getPdmDtoConverter().toMatchTkDto(message.getDictionary());
