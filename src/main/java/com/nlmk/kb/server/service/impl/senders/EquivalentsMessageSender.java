...
@Slf4j
@Service
public class EquivalentsMessageSender implements MessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        val sendingDto = pdmDtoConverter.toChemicalEquivalentStdDto(message.getDictionary());
