...
@Service
public class RegisterEquivalentsMessageSender extends BasePdmCreator implements PdmMessageSender, PdmMessageCreator {
    ...
    public Long send(PdmMessage message) {
        ...
        return super.getNsiSender().sendBodyReturnLong(
                super.getPdmDtoConverter().toRegisterEquivalentsDto(message.getDictionary()),
    ...
    public PdmMessage createPdmMessage(ConsumerRecord<Object, Object> consumerRecord) {
        SpRegisterEquivalents pdmObject = (SpRegisterEquivalents) consumerRecord.value();
