...
import nlmk.l3.pdm.SpTkProd;
import org.apache.kafka.clients.consumer.ConsumerRecord;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Service;

@Service
public class SpTkProdSender extends BasePdmCreator {

    public SpTkProdSender(@Value("${kafka.pdm.topic.sp-tk-prod}") String type,
    ...
    Object getBody(PdmMessage message) {
        return super.getPdmDtoConverter().toSpTkProdDto(message.getDictionary());
    }

    @Override
    PdmDictionary getDictionary(ConsumerRecord<Object, Object> consumerRecord) {
        final var pdmObject = (SpTkProd) consumerRecord.value();
