...
@Slf4j
@Service
public class TkNumMessageSender extends BaseSender implements MessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        final var sendingDto = super.getPdmDtoConverter().toTkNumDto(message.getDictionary());
