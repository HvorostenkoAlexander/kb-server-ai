...
import nlmk.l3.pdm.SpChoiceTestedProducts;
import org.apache.kafka.clients.consumer.ConsumerRecord;
import org.springframework.beans.factory.annotation.Value;
import org.springframework.stereotype.Service;

@Service
public class ChoiceTestedProductsSender extends BasePdmCreator {

    public ChoiceTestedProductsSender(@Value("${kafka.pdm.topic.choice-tested-products}") String type,
    ...
    Object getBody(PdmMessage message) {
        return super.getPdmDtoConverter().toChoiceTestedProducts(message.getDictionary());
    }

    @Override
    PdmDictionary getDictionary(ConsumerRecord<Object, Object> consumerRecord) {
        final var pdmObject = (SpChoiceTestedProducts) consumerRecord.value();
