...
@Service
public class TolThickDtSender extends BasePdmCreator implements PdmMessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        return super.getNsiSender().sendBodyReturnLong(
                super.getPdmDtoConverter().toTolThickDtDto(message.getDictionary()),
