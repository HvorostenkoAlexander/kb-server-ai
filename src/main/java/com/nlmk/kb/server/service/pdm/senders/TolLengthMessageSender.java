...
@Slf4j
@Service
public class TolLengthMessageSender extends BasePdmCreator implements PdmMessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        final var sendingDto = super.getPdmDtoConverter().toLengthTkLimitDto(message.getDictionary());
    ...
    public PdmMessage createPdmMessage(ConsumerRecord<Object, Object> consumerRecord) {
        SpTolLength pdmObject = (SpTolLength) consumerRecord.value();
