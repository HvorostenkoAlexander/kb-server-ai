...
@Slf4j
@Service
public class TolThickMessageSender extends BaseCreator implements MessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        final var sendingDto = super.getPdmDtoConverter().toThicknessTkLimitDto(message.getDictionary());
