...
@Slf4j
@Service
public class AsapMechPropertiesMessageSender implements MessageSender, PdmMessageCreator {
    ...
    public AsapMechPropertiesMessageSender(PdmDtoConverter pdmDtoConverter,
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        val sendingDto = pdmDtoConverter.toPhysMechPropertiesDto(message.getDictionary());
