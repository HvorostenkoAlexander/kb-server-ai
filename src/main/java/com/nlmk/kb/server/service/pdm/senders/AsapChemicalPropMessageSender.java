...
@Service
public class AsapChemicalPropMessageSender extends BasePdmCreator implements PdmMessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        return super.getNsiSender().exchange(
                super.getPdmDtoConverter().toChemicalStdLimitDto(message.getDictionary()),
