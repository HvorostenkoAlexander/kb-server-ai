...
public class MatchRpNumMessageSender implements MessageSender {
    ...
    public MatchRpNumMessageSender(RestTemplateBuilder restTemplateBuilder,
                                   @Value("${nsi.url.match-rabplan-num}") String url_dictionary,
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        HttpEntity<MatchRpDto> request = new HttpEntity<>(sendingDto,header);
