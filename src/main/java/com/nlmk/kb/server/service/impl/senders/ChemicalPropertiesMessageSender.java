...
@Slf4j
@Service
public class ChemicalPropertiesMessageSender extends BaseSender implements MessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        final var sendingDto = super.getPdmDtoConverter().toChemicalTkLimitDto(message.getDictionary());
