...
@Service
public class AsapMechPropertiesMessageSender extends BasePdmCreator implements PdmMessageSender, PdmMessageCreator {
    ...
    public ResponseEntity<Long> send(PdmMessage message) {
        ...
        return super.getNsiSender().exchange(
                super.getPdmDtoConverter().toPhysMechPropertiesDto(message.getDictionary()),
    ...
    public PdmMessage createPdmMessage(ConsumerRecord<Object, Object> consumerRecord) {
        SpAsapMechProperties pdmObject = (SpAsapMechProperties) consumerRecord.value();
