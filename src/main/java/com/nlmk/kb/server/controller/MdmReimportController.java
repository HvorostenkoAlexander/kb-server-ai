...
@RequestMapping(value = "/mdm/reimport", produces = MediaType.APPLICATION_JSON_VALUE)
public interface MdmReimportController {
    ...
    @PostMapping("/start")
    String postReimportStart(@RequestBody @Valid ReimportRequestDto request);
